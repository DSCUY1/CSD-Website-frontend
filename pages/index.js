          ...
          <div className="col">
            <div className="row">
              <div className="col section-presentation-header border-0">
                ...
                <h3 className="card-title pres_title">Département d'Informatique</h3>
              </div>
            </div>
            ...
            <div className="col-md-4 pt-3">
                ...
                <div className="pt-2">
                    <form className="needs-validation" novalidate>
                        <div className="mb-1">
                            <label for="exampleFormControlInput1" className=" fs-13 form-label text-muted fst-italic">Nom <span class="color-pink fw-bold">*</span></label>
                            <input type="email" className="form-control rounded-0" id="exampleFormControlInput1" placeholder="" />
                        </div>

                        <div className="mb-1">
                            <label for="exampleFormControlInput1" className=" fs-13 form-label text-muted fst-italic">Adresse mail <span class="color-pink fw-bold">*</span></label>
                            <input type="email" className="form-control rounded-0" id="exampleFormControlInput1" placeholder="" />
                        </div>

                        <div className="mb-1">
                            <label for="exampleFormControlTextarea1" class=" fs-13 form-label text-muted fst-italic">Message <span class="color-pink fw-bold">*</span></label>
                            <div className="content_send position-relative">
                                ...
                                <button className="btn_send" type="button">envoyer</button>
                            </div>
                        </div>
                    </form>
                </div>
