    ...
    <div className="article-important col-sm-6 col-md-4 col-xs-12 col-lg-4 mt-3 ">
      <div className="card w-100 max-height shadow-sm me-3 article">
        ...
        <div className="card-body font-small article-body">
          <p className="card-title pb-3 color-violet">Comment Shikamaru Nara arrive à gagner les combats sans être fort physiquement?</p>
          <small className="text-muted">Mars 2021</small>
          ...
          <a className="btn color-dark-pink fst-italic">Lire</a>
        </div>
      </div>
    </div>
  );
